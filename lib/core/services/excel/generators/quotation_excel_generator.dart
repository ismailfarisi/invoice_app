...
class QuotationExcelGenerator {
  static Future<Uint8List?> generate(
    ...
    titleCell.value = TextCellValue('QUOTATION');
    ...
    sheetObject
        ...
        .value = TextCellValue(
      quotation.quotationNumber.toString(),
    );
    sheetObject
            .cell(
              CellIndex.indexByColumnRow(columnIndex: 5, rowIndex: currentRow),
    ...
    sheetObject
        ...
        .value = TextCellValue(
      quotation.date != null
          ? DateFormat('dd-MMM-yy').format(quotation.date!)
          : '-',
    );
    currentRow++;
    ...
    sheetObject
        .cell(CellIndex.indexByColumnRow(columnIndex: 1, rowIndex: currentRow))
        .value = TextCellValue(
      quotation.client.name.toString(),
    );
    sheetObject
            .cell(
              CellIndex.indexByColumnRow(columnIndex: 1, rowIndex: currentRow),
    ...
    sheetObject
        .cell(CellIndex.indexByColumnRow(columnIndex: 1, rowIndex: currentRow))
        .value = TextCellValue(
      quotation.client.address.toString(),
    );
    currentRow++;
    ...
    addTotalRow('Subtotal', quotation.subtotal, false);
    if ((quotation.isVatApplicable ?? true) && quotation.taxAmount > 0) {
      addTotalRow('VAT', quotation.taxAmount, false);
    }
    addTotalRow('Total', quotation.total, true);
    currentRow += 2;
    ...
    if (quotation.termsAndConditions != null &&
      ...
      var termsCell = sheetObject.cell(
        CellIndex.indexByColumnRow(columnIndex: 0, rowIndex: currentRow),
      );
      termsCell.value = TextCellValue(
        'Terms & Conditions: ${quotation.termsAndConditions}',
      );
      termsCell.cellStyle = labelStyle;
      currentRow += 2;
    }

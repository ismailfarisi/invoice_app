...
class ProformaPdfGenerator {
  static Future<Uint8List> generate(
    ...
    pdf.addPage(
      pw.MultiPage(
        ...
        header: (context) => PdfHeaders.buildQuotationStyleHeader(
          profile,
          image,
          'PROFORMA INVOICE',
        ),
  ...
  static pw.Widget _buildProformaInfoBox(
    ProformaInvoice proforma,
    BusinessProfile? profile,
  ) {
    return pw.Container(
  ...
  static pw.Widget _buildProformaItemsTable(ProformaInvoice proforma) {
    return pw.Table(
  ...
  static pw.Widget _buildProformaClosing(
    ProformaInvoice proforma,
    BusinessProfile? profile,
  ) {
    return pw.Column(
